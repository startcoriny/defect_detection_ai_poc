...
LABEL_ROOT = PROJECT_ROOT / "auto-labels" / "yolo-labels"
PREDICTION_METADATA_ROOT = PROJECT_ROOT / "auto-labels" / "prediction-metadata"
...
IMAGE_ROOT = PROJECT_ROOT / "data" / "processed" / "dataset_v1" / "images" / "test"
CVAT_IMPORT_ROOT = PROJECT_ROOT / "auto-labels" / "cvat-import"
OUTPUT_ROOT = PROJECT_ROOT / "outputs" / "auto-label-visualization"
MISMATCHES_PATH = PROJECT_ROOT / "metadata" / "auto_label_roundtrip_mismatches.csv"
